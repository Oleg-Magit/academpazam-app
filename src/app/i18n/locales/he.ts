export const he = {
    ...
    'help.workflow.step5_body': 'נתוני התואר הרגילים נשמרים מקומית בדפדפן. תכונות AI הן אופציונליות ושולחות רק את המקור שבחרתם במפורש; התוצאה נבדקת לפני שמירה מקומית.',
    ...
    'legal.privacy.body': 'אקדמפז"ם נבנתה עם פילוסופיה של פרטיות תחילה. נתוני התואר הרגילים נשמרים מקומית בדפדפן. תכונות AI הן אופציונליות ושולחות רק את המקור שבחרתם במפורש; מסד הנתונים המקומי המלא אינו נשלח, והתוצאה נבדקת לפני שמירה מקומית.\n\nלכל שאלה, ניתן ליצור קשר עם היוצר דרך [פרופיל LinkedIn](https://www.linkedin.com/in/olegmagit/).\n\nשימו לב: אם תבחקו לתמוך בפרויקט דרך [PayPal](https://paypal.me/OlegMagit), מדיניות הפרטיות החיצונית שלהם תחול על העסקה הספציפית.',
