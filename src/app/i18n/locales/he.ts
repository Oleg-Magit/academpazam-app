export const he = {
    ...
    'help.workflow.title': 'איך זה עובד?',
    'help.workflow.step1': '1. הוספת סמסטר',
    'help.workflow.step1_body': 'השלב הראשון הוא יצירת סמסטר (למשל "סמסטר א"). ללא סמסטר לא ניתן להוסיף קורסים.',
    'help.workflow.step2': '2. הוספת קורסים',
    'help.workflow.step2_body': 'הוסיפו קורסים לסמסטר שיצרתם. השתמשו בכפתור "הוסף קורס" או ב"ייבוא המוני" לחיסכון בזמן.',
    'help.workflow.step3': '3. הוספת נושאים',
    'help.workflow.step3_body': 'בתוך כל קורס, הוסיפו את נושאי הלימוד (פרקים, מטלות וכד\'). זה יאפשר לכם לעקוב אחר ההתקדמות.',
    'help.workflow.step4': '4. מעקב והשלמה',
    'help.workflow.step4_body': 'ככל שתסמנו נושאים כהושלמו, סטטוס הקורס והתקדמות התואר יתעדכנו אוטומטית.',
    'help.privacy.title': 'פרטיות ונתונים',
    'help.privacy.body': 'הנתונים שלכם נשמרים מקומית בלבד (IndexedDB). מומלץ לבצע "ייצוא נתונים" מדי פעם לגיבוי.',
    'help.troubleshooting.title': 'פתרון בעיות',
    'help.troubleshooting.no_add_course': 'אין אפשרות להוסיף קורס? הוסיפו סמסטר קודם.',
    'help.troubleshooting.not_updating': 'אם משהו לא מתעדכן – רעננו את הדף או בצעו ייצוא לגיבוי.',
