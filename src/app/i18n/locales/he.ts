export const he = {
    ...
    'help.troubleshooting.q2': 'אם משהו לא מתעדכן – רענן את הדף או בצע ייצוא נתונים לגיבוי.',
    'help.troubleshooting.title': 'פתרון בעיות',
    'help.welcome_desc': 'ברוכים הבאים לאקדמפז"ם! מדריך מהיר לניהול המסע האקדמי שלכם. עדכונים: https://github.com/Oleg-Magit/academpazam-app',
    'help.welcome_title': 'עזרה וממדריך למשתמש',
    ...
    'help.workflow.step3_body': 'בתוך כל קורס, הוסיפו את נושאי הלימוד כדי לעקוב אחר ההתקדמות.',
    'help.workflow.step4': '4. מעקב והשלמה',
    'help.workflow.step4_body': 'כשיסומנו נושאים כהושלמו, סטטוס הקורס והתקדמות התואר יתעדכנו אוטומטית.',
    'help.workflow.step5': '5. פרטיות ונתונים',
    'help.workflow.step5_body': 'הנתונים שלכם נשמרים מקומית בדפדפן בלבד. שום מידע לא נשלח לשרת.',
    'help.workflow.step6': '6. פתרון בעיות',
    'help.workflow.step6_body': 'אם משהו לא מתעדכן – רענן את הדף או בצע ייצוא נתונים לגיבוי.',
    ...
    'legal.privacy.body': 'אקדמפז"ם תוכננה תוך גישה של פרטיות תחילה. איננו אוספים, שומרים או מעבירים את המידע האישי שלך. כל המידע נשמר אך ורק על המכשיר שלך באמצעות IndexedDB. קשר: https://www.linkedin.com/in/olegmagit/. אם תבחרו לתמוך בנו באמצעות PayPal (https://paypal.me/OlegMagit), מדיניות הפרטיות שלהם תחול על העסקה.',
    'legal.terms.body': 'בעצם השימוש באקדמפז"ם, אתם מסכימים לתנאים הבאים: אקדמפז"ם היא תוכנת קוד פתוח המוגשת "כמות שהיא" תחת רישיון MIT, ללא אחריות מכל סוג. כלי זה מיועד למעקב אישי בלבד. עליכם תמיד לאמת דרישות מול המוסד האקדמי הרשמי שלכם. קשר: https://www.linkedin.com/in/olegmagit/. קוד מקור: https://github.com/Oleg-Magit/academpazam-app. קישורים חיצוניים: https://paypal.me/OlegMagit.',
