export const en = {
    ...
    'help.troubleshooting.q2': 'If something is not updating – refresh the page or perform a data export for backup.',
    'help.troubleshooting.title': 'Troubleshooting',
    'help.welcome_desc': 'Welcome to AcademPazam! A quick guide to managing your academic journey. Updates: https://github.com/Oleg-Magit/academpazam-app',
    'help.welcome_title': 'Help & User Guide',
    'help.workflow.step1': '1. Add a Semester',
    'help.workflow.step1_body': 'Create a semester first (e.g., "Fall 2024"). You cannot add courses without a semester.',
    'help.workflow.step2': '2. Add Courses',
    'help.workflow.step2_body': 'Add courses to your semester. Use "Add Course" or "Bulk Add" to save time.',
    'help.workflow.step3': '3. Add Topics',
    'help.workflow.step3_body': 'Inside each course, add study topics to track your progress.',
    ...
    'help.workflow.step5': '5. Privacy & Data',
    'help.workflow.step5_body': 'Your data is stored locally in your browser. No data is sent to any server.',
    'help.workflow.step6': '6. Troubleshooting',
    'help.workflow.step6_body': 'If something is not updating – refresh the page or perform a data export for backup.',
    ...
    'legal.privacy.body': 'AcademPazam is designed with a privacy-first approach. We do not collect, store, or transmit your personal data. All information is stored locally on your device via IndexedDB. Contact: https://www.linkedin.com/in/olegmagit/. If you choose to support us via PayPal (https://paypal.me/OlegMagit), their privacy policy applies to the transaction.',
    'legal.terms.body': 'By using AcademPazam, you agree to these terms: AcademPazam is open-source software provided "as is" under the MIT License, without warranty of any kind. This tool is for personal tracking. Always verify requirements with your official academic institution. Contact: https://www.linkedin.com/in/olegmagit/. Source: https://github.com/Oleg-Magit/academpazam-app. Third-party links: https://paypal.me/OlegMagit.',
